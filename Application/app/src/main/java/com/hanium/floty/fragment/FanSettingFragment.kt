...
import kotlinx.android.synthetic.main.fragment_fan_setting.*

class FanSettingFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        var view: View = inflater.inflate(R.layout.fragment_fan_setting, container, false)

        firebaseUser = FirebaseAuth.getInstance().currentUser!!

        var seekbar_light: SeekBar = view.findViewById(R.id.range)
        var percent: TextView = view.findViewById(R.id.percent)
        var fanImg: ImageView = view.findViewById(R.id.cloud)
    ...
    fun loadRate() {
        mReference = FirebaseDatabase.getInstance().getReference("Fan").child(firebaseUser.uid)

        val fanlistener = object : ValueEventListener {
        ...
        mReference.addValueEventListener(fanlistener)
    }
